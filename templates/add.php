    ...
    <nav class="nav">
        <ul class="nav__list container">
            ...
            foreach ($categories as $category): ?>
                <li class="nav__item">
                    <a href="all-lots.html"><?= $category ['categories_name']; ?></a>
                </li>
            <?php endforeach; ?>
        </ul>
    </nav>
    <form class="form form--add-lot container form--invalid" enctype="multipart/form-data" action="/add.php" method="post">
        <!-- form--invalid -->
        <h2>Добавление лота</h2>
        <div class="form__container-two">
            <div class="form__item <?= (!empty($form_errors['lot-name']) && $form_errors['lot-name'] == true) ? 'form__item--invalid' : '' ?>  "> <!-- form__item--invalid -->
